...
<head>
	...
	<meta name="keywords" content="yoga,gentle,relaxing,restoring,Laura Holvey,Freshford near Bath" />
	<meta name="author" content="Jonathan Holvey" />
	<meta name="google-site-verification" content="3zV7GHS_K0GJ2wQ66AWc39dYTRAO9ss3xWyxv_5haUo" />
	<?php include("resources.php"); ?>
	<style type="text/css">#homeLink {color:#2E5963 !important;cursor:default}</style>
</head>
<body>
	...
	<div class="page-text column half left">
		...
		<p><b>One to one class</b> in my home or garden (weather permitting) or your home. Yoga for fatigue - an extremely gentle class that could help with stress or illness that has left you feeling fatiuged.
