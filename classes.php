...
<head>
	<title>Simple Yoga - Classes</title>
	...
	<style type="text/css">#classesLink {color:#2E5963 !important;cursor:default}</style>
</head>
<body>
	<?php include("header.php"); ?>
	
	<div class="content">
		<!--div class="title">Simple Yoga at Freshford Village Hall</div>
		<p>Near Bath - <a href="http://maps.google.co.uk/maps?hl=en&ll=51.339004,-2.310884&spn=0.011863,0.033023&hnear=Bristol,+United+Kingdom&t=m&z=16&iwloc=lyrftr:m,16501280131153264604,51.339004,-2.310905">Click here for map</a></p>
		<p>Thursdays 2:00-3:00 PM</p>
		<p>&pound; 5.00 for your first class and &pound; 25.00 for a block of five. A single drop in session is &pound; 6.00.</p>
		<p>Wear comfortable clothing and bring a mat and blanket for relaxation. If you don't have your own mat I have a few you can borrow or purchase.</p>
		<p>There is plenty of parking at the Village Hall. Please do get in touch if you have any questions.</p-->
		<!--div class="title">Chair Yoga</div>
		<p>Chair Yoga around my kitchen table or yours.</p>
		<p>A gentle yoga class that includes postures to improve the muscle tone of the face as well as the body, improve your posture and help you to look as young as you feel.</p>
		...
		<p>I keep postures very gentle and emphasis concentration on the breath which allows you to fully relax and in turn leads to increased energy.</p>
		<p>I teach very intuitively, we work at your own pace, only doing what you feel you can manage on the day. Most postures are done lying down or sitting in a chair, wherever you feel most comfortable. We finish with a long guided relaxation which allows you to fully relax. You can benefit from this gentle, relaxing class, no matter what your energy levels are like.</p>
		<p>I teach private classes, or one to one sessions in your home. Please phone for a supportive chat or to arrange a free visit.</p>
<!-- 		<div class="title">Face Yoga</div>
		<p>Yoga helps tone and relax the body and your face is no different. With face yoga we start with balancing our body, then really study our face, noting tension and long held habits, and work on retraining our facial muscles. This helps to lift, smooth and improve our skin tone. We use massage and relaxation techniques, and laughter is included!</p>
		<p>Even more importantly, we accept and enjoy what we cannot change, allowing us to relax, and remove tension and stress which can show clearly in our faces.</p> -->
<!-- 		<div class="title">Simple yoga in local schools and Care Homes</div>
		<p>Teaching the young and not so young is a joy. Please phone for further details.</p>
 -->		<?php printQuote() ?>
	</div>
